...
const Signup = () => {
  ...
  return (
    <article className="border-2 shadow-lg rounded-md max-w-[30vw] min-w-[35vw] border-[#BB3E00] p-8">
      <form onClick={handleSubmit(onSubmit)} className="grid gap-1.5" >
        ...
        <button onClick={()=> dispatch(signInWithGoogle())} type="submit" className="border-2 flex items-center justify-center gap-2 border-[#BB3E00] text-[#BB3E00] cursor-pointer  font-semibold py-2 px-4 rounded-md mt-4">SignUp with Google <FcGoogle/> </button>
